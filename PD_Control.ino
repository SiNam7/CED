...
#define _SERVO_SPEED 480        // [3141] servo 속도 설정
...
// PID parameters
#define _KP_NEAR 0.95  //0.95
#define _KP_FAR 1.02 //1.1
#define _KD_NEAR 40.8
#define _KD_FAR 41.0

#define _KP 1.1
#define _KD 35.5  //35.5
...
//    Serial.print(map(filtered_dist,30, 130, 100, 420)); 
//    Serial.print(",dterm:");
